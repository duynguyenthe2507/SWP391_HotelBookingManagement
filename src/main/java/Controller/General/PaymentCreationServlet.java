 ...
 */
@WebServlet(name = "PaymentCreationServlet", urlPatterns = {"/createPayment"})
public class PaymentCreationServlet extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(PaymentCreationServlet.class.getName());
